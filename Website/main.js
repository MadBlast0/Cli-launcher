...
function initAppDemo() {
  ...
  const catalog = [
    ...
    { id: 'omp', name: 'Oh My Pi', version: '0.18.0', pkg: '@oh-my-pi/pi-coding-agent', group: 'npm (Node.js)', logo: 'media/cli/omp.svg' },
    ...
    { id: 'hermes', name: 'Hermes Agent', version: '0.18.1', pkg: 'hermes-agent', group: 'pip (Python)', logo: 'media/cli/hermes.svg' },
